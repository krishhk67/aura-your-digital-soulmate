...
export function ChatWindow({ chatId, onBack }: ChatWindowProps) {
  ...
  return (
    <div data-chat-surface className="h-full flex flex-col bg-background relative transition-colors duration-300 ease-out [&_*]:transition-colors [&_*]:duration-300" {...(chatTheme ? { "data-theme": chatTheme } : {})}>
      {moodGlow && (
